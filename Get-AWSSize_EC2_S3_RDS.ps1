...
<#
  ...
  .DESCRIPTION
    The sizing script gets all EC2 instances, EC2 unattached volumes and RDS databases
    ...
    to Cohesity, copy/paste the console output along with attaching the CSV files.
...
Write-Host
Write-Host ("        'Owner = Cohesity' and 'owner = Cohesity' are two different tags in S3.") -ForegroundColor Yellow
Write-Host
...
Write-Host
Write-Host
Write-Host "Please send $archiveFile to your Cohesity SE for review" -ForegroundColor Green
Write-Host